...
class Gif(object):
    ...
    def pops(self, fmt):
        ...
        return struct.unpack(fmt, self.pop(size))
    ...
    def pop_bits(self, length):
        ...
        bytes_list = self.pops('<' + str(length) + 'B')
        plain = []
...
class ImageDescriptor(object):
    ...
    def setup_header(self, header):
        ...
        assert not self.local_color_table_flag, \
